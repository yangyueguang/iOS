...
static NSString *const CanAcceptTouchNotificationName = @"canAcceptTouch";//可以接受触摸
/// K线图需要加载更多数据的通知
...
///背景框的宽度
extern CGFloat const HYStockChartTimeLineGridWidth ;
...
///K线图的成交量上最小的Y
#define HYStockChartKLineBelowViewMinY 5
/// K线图的成交量最大的Y
#define HYStockChartKLineBelowViewMaxY (self.frame.size.height)
///时分线图的Above上最小的Y
#define HYStockChartTimeLineAboveViewMinY 10
///时分线图的Above上最大的Y
...
///时分线图的Below最小的X
#define HYStockChartTimeLineBelowViewMinX 0.0
/// 时分线的成交量的线宽
