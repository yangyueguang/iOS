...
//    CGContextStrokeRect(context, CGRectMake(0, 0, rect.size.width , rect.size.height));
    [self drawline:context startPoint:CGPointMake(0, 0) stopPoint:CGPointMake(rect.size.width, 0) color:GridLineColor lineWidth:HYStockChartTimeLineGridWidth];
    
    [self drawline:context startPoint:CGPointMake(0, HYStockChartKLineBelowViewMinY) stopPoint:CGPointMake(rect.size.width, HYStockChartKLineBelowViewMinY) color:[UIColor colorWithWhite:226/255.0 alpha:1] lineWidth:0.25];
