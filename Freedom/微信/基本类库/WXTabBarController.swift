...
//        return childVCArray
//    }
//    func conversationVC() -> WXConversationViewController? {
//        if conversationVC == nil {
//            conversationVC = WXConversationViewController()
...
//    }
//
//    func friendsVC() -> WXFriendsViewController? {
//        if friendsVC == nil {
//            friendsVC = WXFriendsViewController()
...
//        return friendsVC
//    }
//    func discoverVC() -> WXDiscoverViewController? {
//        if discoverVC == nil {
//            discoverVC = WXDiscoverViewController()
...
//    }
//
//    func mineVC() -> WXMineViewController? {
//        if mineVC == nil {
//            mineVC = WXMineViewController()
...
//            vc?.title = dict["title"]
//            var nav: WXNavigationController? = nil
//            if let aVc = vc {
//                nav = WXNavigationController(rootViewController: aVc)
//            }
//            let item: UITabBarItem? = nav?.tabBarItem
//            item?.title = dict?["title"
//            item?.image = UIImage(named: dict?["imageName"] as? String ?? "")
//            item?.selectedImage = (UIImage(named: dict?["selectedImageName"] as? String ?? ""))?.withRenderingMode(.alwaysOriginal)
...
//        let proxy = WXMessageManager.sharedInstance() as? WXMessageManager
