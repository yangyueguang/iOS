...
//FIXME: 基本控制器
class WXChatBaseViewController: WXBaseViewController {
...
extension WXChatBaseViewController: WXChatBarDelegate {
    func chatBar(_ chatBar: WXChatBar, changeStatusFrom fromStatus: TLChatBarStatus, to toStatus: TLChatBarStatus) {
...
extension WXChatBaseViewController: WXChatViewControllerProxy {
    func didClickedUserAvatar(_ user: WXUser) {
