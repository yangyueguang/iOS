...
//            default:break
//            }
//            markAsRead(self.conversation.isRead)
//        }
//    }
//    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String) {
//        super.init(style: style, reuseIdentifier: reuseIdentifier)
...
//            case .point:redPointView.setHidden(isRead)
//            case .none:break
//            default:break
//            }
//        }
...
//        WXMessageManager.shared.setConversationDelegate(self)
...
//        cell.bottomLineStyle = indexPath.row == data.count - 1 ? .fill : .defualt
//        return cell!
//    }
//    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
//        return 80
...
//            cell.markAsUnread(!conversation.isRead)
