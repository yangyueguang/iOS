...
- (void) p_initTestData{
    WXSettingItem *item1 = [WXSettingItem createItemWithTitle:(@"接受新消息通知")];
    item1.subTitle = @"已开启";
