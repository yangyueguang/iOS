...
- (void) p_initTestData{
    WXSettingItem *item1 = [WXSettingItem createItemWithTitle:(@"加我为好友时需要验证")];
    item1.type = TLSettingItemTypeSwitch;
    WXSettingGroup *group1 = TLCreateSettingGroup(@"通讯录", nil, @[item1]);
    
    WXSettingItem *item2 = [WXSettingItem createItemWithTitle:(@"向我推荐QQ好友")];
    item2.type = TLSettingItemTypeSwitch;
    WXSettingItem *item3 = [WXSettingItem createItemWithTitle:(@"通过QQ号搜索到我")];
    item3.type = TLSettingItemTypeSwitch;
    WXSettingGroup *group2 = TLCreateSettingGroup(nil, nil, (@[item2, item3]));
    
    WXSettingItem *item4 = [WXSettingItem createItemWithTitle:(@"可通过手机号搜索到我")];
    item4.type = TLSettingItemTypeSwitch;
    WXSettingItem *item5 = [WXSettingItem createItemWithTitle:(@"向我推荐通讯录好友")];
    item5.type = TLSettingItemTypeSwitch;
    WXSettingGroup *group3 = TLCreateSettingGroup(nil, @"开启后，为你推荐已经开通微信的手机联系人", (@[item4, item5]));
    
    WXSettingItem *item6 = [WXSettingItem createItemWithTitle:(@"通过微信号搜索到我")];
    item6.type = TLSettingItemTypeSwitch;
    WXSettingGroup *group4 = TLCreateSettingGroup(nil, @"关闭后，其他用户将不能通过微信号搜索到你", @[item6]);
    
    WXSettingItem *item7 = [WXSettingItem createItemWithTitle:(@"通讯录黑名单")];
    WXSettingGroup *group5 = TLCreateSettingGroup(nil, nil, @[item7]);
    
    WXSettingItem *item8 = [WXSettingItem createItemWithTitle:(@"不让他(她)看我的朋友圈")];
    WXSettingItem *item9 = [WXSettingItem createItemWithTitle:(@"不看他(她)的朋友圈")];
    WXSettingGroup *group6 = TLCreateSettingGroup(@"朋友圈", nil, (@[item8, item9]));
    
    WXSettingItem *item10 = [WXSettingItem createItemWithTitle:(@"允许陌生人查看十张照片")];
